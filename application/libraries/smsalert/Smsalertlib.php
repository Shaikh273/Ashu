...
class Smsalertlib
{
    private $user = 'maazoly1@gmail.com'; // write your SMSAlert Username in between ''
    private $pass = 'mdt0WQW!'; // write your SMSAlert Password in between ''
    private $senderid = 'CVDemo'; // write your Sender ID in between ''
