...
INSERT INTO `history_systemic_history` (`id`, `C_id`, `pat_id`, `systemic_history_type`, `name`, `duration`, `duration_unit`, `comments1`, `comments2`, `family_history`, `medical_history`, `special_status`, `created_at`, `updated_at`) VALUES
